...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: #e9eaec;\n}\n\n.main-grid {\n  position: relative;\n  min-height: 100vh;\n}\n.main-grid .content-wrap {\n  padding-bottom: 2.5rem;\n}\n\nheader {\n  background-color: #333652;\n  color: #e9eaec;\n  height: 64px;\n  padding: 0.7em;\n  padding-right: 1em;\n}\nheader div {\n  display: flex;\n  justify-content: space-between;\n}\nheader .hero {\n  font-size: 36px;\n}\n\nbutton,\n.submit-btn {\n  border: none;\n}\n\n.nav button,\nheader button {\n  background-color: transparent;\n  color: #e9eaec;\n}\n.nav button i,\nheader button i {\n  font-size: 36px;\n}\n\n.nav {\n  height: 100vh;\n  width: 0;\n  position: fixed;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  background-color: #333652;\n  color: #e9eaec;\n  overflow-x: hidden;\n  transition: 0.5s;\n  padding-top: 3em;\n  font-size: 24px;\n  z-index: 100;\n}\n.nav ul {\n  margin-bottom: 1em;\n}\n.nav ul li {\n  margin-bottom: 0.3em;\n}\n.nav a {\n  color: #e9eaec;\n}\n.nav a:visited {\n  color: #e9eaec;\n}\n.nav a:hover {\n  color: #fad02c;\n}\n.nav a i {\n  margin-right: 10px;\n}\n.nav .close-nav-btn {\n  line-height: 38.7px;\n  padding-bottom: 6.2px;\n  position: absolute;\n  top: 15px;\n  right: 25px;\n  font-size: 58px;\n  margin-left: 50px;\n}\n.nav .line {\n  height: 1px;\n  background: #e9eaec;\n  max-width: 90%;\n  margin-bottom: 0.5em;\n}\n\n.dash-board {\n  padding: 1em;\n}\n\n.form {\n  margin: 0 auto;\n  padding: 25px;\n  padding-bottom: 50px;\n  max-width: 400px;\n  border: 1px solid black;\n  border-radius: 6px;\n}\n.form input, .form .cancel-btn {\n  height: 38px;\n}\n.form .task-input {\n  width: 100%;\n}\n.form fieldset {\n  margin-bottom: 15px;\n  border: none;\n}\n.form textarea {\n  resize: none;\n  width: 100%;\n}\n.form textarea,\n.form input, .form .radio-btn > label {\n  padding-left: 5px;\n  padding-right: 5px;\n  border-radius: 4px;\n}\n.form #task-date:hover {\n  cursor: pointer;\n}\n.form .radio-container {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 10px;\n}\n.form .radio-btn {\n  position: relative;\n}\n.form .radio-btn label,\n.form .radio-btn input {\n  display: block;\n}\n.form .radio-btn input[type=radio] {\n  opacity: 0.011;\n  z-index: 100;\n  position: absolute;\n}\n.form .radio-btn input[type=radio]:checked + label {\n  background-color: #039862;\n}\n.form .radio-btn label {\n  border: 2px solid black;\n  padding: 2px 6px;\n  text-align: center;\n  cursor: pointer;\n  z-index: 90;\n  line-height: 1.8em;\n}\n.form .form-btn-container {\n  float: right;\n}\n.form .form-btn-container .submit-btn {\n  background-color: #039862;\n}\n.form .form-btn-container .submit-btn:hover {\n  cursor: pointer;\n}\n.form .form-btn-container .cancel-btn {\n  background-color: rgb(213, 70, 70);\n}\n.form .form-btn-container .submit-btn,\n.form .form-btn-container .cancel-btn {\n  padding: 0.5em;\n  border-radius: 4px;\n}\n\nfooter {\n  text-align: center;\n  position: absolute;\n  bottom: 0;\n  width: 100%;\n  height: 2.5rem;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAaA;EACE,yBAXc;AAAhB;;AAcA;EACE,kBAAA;EACA,iBAAA;AAXF;AAYE;EACE,sBAAA;AAVJ;;AAcA;EACE,yBAtBgB;EAuBhB,cAxBc;EAyBd,YAAA;EACA,cAAA;EACA,kBAAA;AAXF;AAYE;EACE,aAAA;EACA,8BAAA;AAVJ;AAYE;EACE,eAAA;AAVJ;;AAcA;;EAEE,YAAA;AAXF;;AAgBE;;EACE,6BAAA;EACA,cA9CY;AAkChB;AAaI;;EACE,eAAA;AAVN;;AAeA;EACE,aAAA;EACA,QAAA;EACA,eAAA;EACA,UAAA;EACA,MAAA;EACA,OAAA;EACA,yBA3DgB;EA4DhB,cA7Dc;EA8Dd,kBAAA;EACA,gBAAA;EACA,gBAAA;EACA,eAAA;EACA,YAAA;AAZF;AAaE;EACE,kBAAA;AAXJ;AAYI;EACE,oBAAA;AAVN;AAaE;EACE,cA1EY;AA+DhB;AAYI;EACE,cA5EU;AAkEhB;AAYI;EACE,cA7EY;AAmElB;AAYI;EACE,kBAAA;AAVN;AAaE;EACE,mBAAA;EACA,qBAAA;EACA,kBAAA;EACA,SAAA;EACA,WAAA;EACA,eAAA;EACA,iBAAA;AAXJ;AAaE;EACE,WAAA;EACA,mBAhGY;EAiGZ,cAAA;EACA,oBAAA;AAXJ;;AAeA;EACE,YAAA;AAZF;;AAeA;EACE,cAAA;EACA,aAAA;EACA,oBAAA;EACA,gBAAA;EACA,uBAAA;EACA,kBA1GqB;AA8FvB;AAaE;EACE,YA1GkB;AA+FtB;AAaE;EACE,WAAA;AAXJ;AAaE;EACE,mBAAA;EACA,YAAA;AAXJ;AAaE;EACE,YAAA;EACA,WAAA;AAXJ;AAaE;;EAEE,iBAAA;EACA,kBAAA;EACA,kBA5HmB;AAiHvB;AAeI;EACE,eAAA;AAbN;AAgBE;EACE,aAAA;EACA,qCAAA;EACA,SAAA;AAdJ;AAgBE;EACE,kBAAA;AAdJ;AAeI;;EAEE,cAAA;AAbN;AAeI;EACE,cAAA;EACA,YAAA;EACA,kBAAA;AAbN;AAcM;EACE,yBAAA;AAZR;AAeI;EACE,uBAAA;EACA,gBAAA;EACA,kBAAA;EACA,eAAA;EACA,WAAA;EACA,kBAAA;AAbN;AAgBE;EACE,YAAA;AAdJ;AAeI;EACE,yBAtKS;AAyJf;AAcM;EACE,eAAA;AAZR;AAeI;EACE,kCA3KS;AA8Jf;AAeI;;EAEE,cAAA;EACA,kBA9KiB;AAiKvB;;AAkBA;EACE,kBAAA;EACA,kBAAA;EACA,SAAA;EACA,WAAA;EACA,cAAA;AAfF","sourcesContent":["@import url('reset.css');\n\n//color scheme\n$primary-color: #e9eaec;\n$secondary-color: #333652;\n$highlight-color: #fad02c;\n$active-color: #90adc6;\n$submit-color: #039862;\n$cancel-color: rgb(213, 70, 70);\n$border-radius__outer: 6px;\n$border-radius__inner: 4px;\n$input-button-height: 38px;\n\nbody {\n  background-color: $primary-color;\n}\n\n.main-grid {\n  position: relative;\n  min-height: 100vh;\n  .content-wrap {\n    padding-bottom: 2.5rem;\n  }\n}\n\nheader {\n  background-color: $secondary-color;\n  color: $primary-color;\n  height: 64px;\n  padding: 0.7em;\n  padding-right: 1em;\n  div {\n    display: flex;\n    justify-content: space-between;\n  }\n  .hero {\n    font-size: 36px;\n  }\n}\n\nbutton,\n.submit-btn {\n  border: none;\n}\n\n.nav,\nheader {\n  button {\n    background-color: transparent;\n    color: $primary-color;\n    i {\n      font-size: 36px;\n    }\n  }\n}\n\n.nav {\n  height: 100vh;\n  width: 0;\n  position: fixed;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  background-color: $secondary-color;\n  color: $primary-color;\n  overflow-x: hidden;\n  transition: 0.5s;\n  padding-top: 3em;\n  font-size: 24px;\n  z-index: 100;\n  ul {\n    margin-bottom: 1em;\n    li {\n      margin-bottom: 0.3em;\n    }\n  }\n  a {\n    color: $primary-color;\n    &:visited {\n      color: $primary-color;\n    }\n    &:hover {\n      color: $highlight-color;\n    }\n    i {\n      margin-right: 10px;\n    }\n  }\n  .close-nav-btn {\n    line-height: 38.7px;\n    padding-bottom: 6.2px;\n    position: absolute;\n    top: 15px;\n    right: 25px;\n    font-size: 58px;\n    margin-left: 50px;\n  }\n  .line {\n    height: 1px;\n    background: $primary-color;\n    max-width: 90%;\n    margin-bottom: 0.5em;\n  }\n}\n\n.dash-board {\n  padding: 1em;\n}\n\n.form {\n  margin: 0 auto;\n  padding: 25px;\n  padding-bottom: 50px;\n  max-width: 400px;\n  border: 1px solid black;\n  border-radius: $border-radius__outer;\n  input, .cancel-btn {\n    height: $input-button-height;\n  }\n  .task-input {\n    width: 100%;\n  }\n  fieldset {\n    margin-bottom: 15px;\n    border: none;\n  }\n  textarea {\n    resize: none;\n    width: 100%;\n  }\n  textarea,\n  input, .radio-btn > label {\n    padding-left: 5px;\n    padding-right: 5px;\n    border-radius: $border-radius__inner;\n  }\n\n  #task-date {\n    &:hover {\n      cursor: pointer;\n    }\n  }\n  .radio-container {\n    display: grid;\n    grid-template-columns: repeat(3, 1fr);\n    gap: 10px;\n  }\n  .radio-btn {\n    position: relative;\n    label,\n    input {\n      display: block;\n    }\n    input[type='radio'] {\n      opacity: 0.011;\n      z-index: 100;\n      position: absolute;\n      &:checked + label {\n        background-color: #039862;\n      }\n    }\n    label {\n      border: 2px solid black;\n      padding: 2px 6px;\n      text-align: center;\n      cursor: pointer;\n      z-index: 90;\n      line-height: 1.8em;\n    }\n  }\n  .form-btn-container {\n    float: right;\n    .submit-btn {\n      background-color: $submit-color;\n      &:hover {\n        cursor: pointer;\n      }\n    }\n    .cancel-btn {\n      background-color: $cancel-color;\n    }\n    .submit-btn,\n    .cancel-btn {\n      padding: 0.5em;\n      border-radius: $border-radius__inner;\n    }\n  }\n}\n\nfooter {\n  text-align: center;\n  position: absolute;\n  bottom: 0;\n  width: 100%;\n  height: 2.5rem;\n}\n"],"sourceRoot":""}]);
// Exports
