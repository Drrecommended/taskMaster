...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "button {\n  background-color: white;\n  min-height: 58px;\n  min-width: 58px;\n}\n\n.wrapper {\n  max-width: 1200px;\n  padding: 14px;\n  margin: 0 auto;\n}\n\nheader .wrapper {\n  display: flex;\n  justify-content: space-between;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAGA;EACE,uBAAA;EACA,gBAAA;EACA,eAAA;AADF;;AAMA;EACE,iBAAA;EACA,aAAA;EACA,cAAA;AAHF;;AAOE;EACE,aAAA;EACA,8BAAA;AAJJ","sourcesContent":["@import url('reset.css');\n\n\nbutton {\n  background-color: white;\n  min-height: 58px;\n  min-width: 58px;\n}\n\n\n\n.wrapper {\n  max-width: 1200px;\n  padding: 14px;\n  margin: 0 auto;\n}\n\nheader {\n  .wrapper {\n    display: flex;\n    justify-content: space-between;\n  }\n}"],"sourceRoot":""}]);
// Exports
