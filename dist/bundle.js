...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: #e9eaec;\n  font-size: 18px;\n}\n\n.main-grid {\n  position: relative;\n  min-height: 100vh;\n}\n.main-grid .content-wrap {\n  padding-bottom: 2.5rem;\n}\n\n.flex {\n  display: flex;\n}\n\nheader {\n  background-color: #333652;\n  color: #e9eaec;\n  height: 64px;\n  padding: 0.7em;\n  padding-right: 1em;\n}\nheader div {\n  display: flex;\n  justify-content: space-between;\n}\nheader .hero {\n  font-size: 36px;\n}\n\nbutton,\n.submit-btn {\n  border: none;\n}\n\n.nav button,\nheader button {\n  background-color: transparent;\n  color: #e9eaec;\n}\n.nav button i,\nheader button i {\n  font-size: 36px;\n}\n\n.nav {\n  height: 100vh;\n  width: 0;\n  position: fixed;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  background-color: #333652;\n  color: #e9eaec;\n  overflow-x: hidden;\n  transition: 0.5s;\n  padding-top: 3em;\n  font-size: 24px;\n  z-index: 100;\n}\n.nav.open {\n  width: 100%;\n  padding-left: 20px;\n}\n.nav ul {\n  margin-bottom: 1em;\n}\n.nav ul li {\n  margin-bottom: 0.3em;\n}\n.nav a {\n  color: #e9eaec;\n}\n.nav a:visited {\n  color: #e9eaec;\n}\n.nav a:hover {\n  color: #fad02c;\n}\n.nav a i {\n  margin-right: 10px;\n}\n.nav .close-nav-btn {\n  line-height: 38.7px;\n  padding-bottom: 6.2px;\n  position: absolute;\n  top: 15px;\n  right: 25px;\n  font-size: 58px;\n  margin-left: 50px;\n}\n.nav .line {\n  height: 1px;\n  background: #e9eaec;\n  max-width: 90%;\n  margin-bottom: 0.5em;\n}\n\n.dash-board {\n  padding: 1em;\n}\n\n.form {\n  margin: 0 auto;\n  padding: 25px;\n  padding-bottom: 50px;\n  max-width: 400px;\n  border: 1px solid black;\n  border-radius: 6px;\n}\n.form.open {\n  display: none;\n}\n.form input,\n.form fieldset {\n  margin-bottom: 12px;\n}\n.form input,\n.form .cancel-btn {\n  height: 42px;\n}\n.form .task-input,\n.form textarea {\n  width: 100%;\n}\n.form fieldset {\n  border: none;\n  padding-bottom: 15px;\n}\n.form textarea {\n  resize: none;\n}\n.form textarea,\n.form input,\n.form .radio-btn > label {\n  padding-left: 5px;\n  padding-right: 5px;\n  border-radius: 4px;\n}\n.form input,\n.form textarea {\n  border: 1px solid black;\n}\n.form #task-date:hover {\n  cursor: pointer;\n}\n.form .radio-container {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 10px;\n}\n.form .radio-btn {\n  position: relative;\n}\n.form .radio-btn label,\n.form .radio-btn input {\n  display: block;\n}\n.form .radio-btn input[type=radio] {\n  opacity: 0.011;\n  z-index: 100;\n  position: absolute;\n}\n.form .radio-btn input[type=radio]:checked + label {\n  border: 2px solid transparent;\n}\n.form .radio-btn .low + label {\n  background-color: red;\n}\n.form .radio-btn .medium + label {\n  background-color: green;\n}\n.form .radio-btn .high + label {\n  background-color: blue;\n}\n.form .radio-btn label {\n  border: 2px solid black;\n  padding: 2px 6px;\n  text-align: center;\n  cursor: pointer;\n  z-index: 90;\n  line-height: 1.8em;\n}\n.form .form-btn-container {\n  float: right;\n}\n.form .form-btn-container .submit-btn {\n  background-color: #84d4b7;\n  border: none;\n  margin-left: 4px;\n}\n.form .form-btn-container .submit-btn:hover {\n  cursor: pointer;\n}\n.form .form-btn-container .cancel-btn {\n  background-color: rgb(235, 132, 132);\n}\n.form .form-btn-container .submit-btn,\n.form .form-btn-container .cancel-btn {\n  padding: 0.5em 0.6em;\n  border-radius: 4px;\n}\n\nfooter {\n  text-align: center;\n  position: absolute;\n  bottom: 0;\n  width: 100%;\n  height: 2.5rem;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAaA;EACE,yBAXc;EAYd,eAAA;AAXF;;AAcA;EACE,kBAAA;EACA,iBAAA;AAXF;AAYE;EACE,sBAAA;AAVJ;;AAcA;EACE,aAAA;AAXF;;AAcA;EACE,yBA3BgB;EA4BhB,cA7Bc;EA8Bd,YAAA;EACA,cAAA;EACA,kBAAA;AAXF;AAYE;EACE,aAAA;EACA,8BAAA;AAVJ;AAYE;EACE,eAAA;AAVJ;;AAcA;;EAEE,YAAA;AAXF;;AAgBE;;EACE,6BAAA;EACA,cAnDY;AAuChB;AAaI;;EACE,eAAA;AAVN;;AAeA;EAKE,aAAA;EACA,QAAA;EACA,eAAA;EACA,UAAA;EACA,MAAA;EACA,OAAA;EACA,yBApEgB;EAqEhB,cAtEc;EAuEd,kBAAA;EACA,gBAAA;EACA,gBAAA;EACA,eAAA;EACA,YAAA;AAhBF;AAAE;EACE,WAAA;EACA,kBAAA;AAEJ;AAaE;EACE,kBAAA;AAXJ;AAYI;EACE,oBAAA;AAVN;AAaE;EACE,cAnFY;AAwEhB;AAYI;EACE,cArFU;AA2EhB;AAYI;EACE,cAtFY;AA4ElB;AAYI;EACE,kBAAA;AAVN;AAaE;EACE,mBAAA;EACA,qBAAA;EACA,kBAAA;EACA,SAAA;EACA,WAAA;EACA,eAAA;EACA,iBAAA;AAXJ;AAaE;EACE,WAAA;EACA,mBAzGY;EA0GZ,cAAA;EACA,oBAAA;AAXJ;;AAeA;EACE,YAAA;AAZF;;AAeA;EACE,cAAA;EACA,aAAA;EACA,oBAAA;EACA,gBAAA;EACA,uBAAA;EACA,kBAnHqB;AAuGvB;AAaE;EACE,aAAA;AAXJ;AAaE;;EAEE,mBAAA;AAXJ;AAaE;;EAEE,YA3HkB;AAgHtB;AAaE;;EAEE,WAAA;AAXJ;AAaE;EACE,YAAA;EACA,oBAAA;AAXJ;AAaE;EACE,YAAA;AAXJ;AAaE;;;EAGE,iBAAA;EACA,kBAAA;EACA,kBA9ImB;AAmIvB;AAaE;;EAEE,uBAAA;AAXJ;AAcI;EACE,eAAA;AAZN;AAeE;EACE,aAAA;EACA,qCAAA;EACA,SAAA;AAbJ;AAeE;EACE,kBAAA;AAbJ;AAcI;;EAEE,cAAA;AAZN;AAcI;EACE,cAAA;EACA,YAAA;EACA,kBAAA;AAZN;AAaM;EACE,6BAAA;AAXR;AAcI;EACE,qBAAA;AAZN;AAcI;EACE,uBAAA;AAZN;AAcI;EACE,sBAAA;AAZN;AAcI;EACE,uBAAA;EACA,gBAAA;EACA,kBAAA;EACA,eAAA;EACA,WAAA;EACA,kBAAA;AAZN;AAeE;EACE,YAAA;AAbJ;AAcI;EACE,yBApMS;EAqMT,YAAA;EACA,gBAAA;AAZN;AAaM;EACE,eAAA;AAXR;AAcI;EACE,oCA3MS;AA+Lf;AAcI;;EAEE,oBAAA;EACA,kBA9MiB;AAkMvB;;AAiBA;EACE,kBAAA;EACA,kBAAA;EACA,SAAA;EACA,WAAA;EACA,cAAA;AAdF","sourcesContent":["@import url('reset.css');\n\n//color scheme\n$primary-color: #e9eaec;\n$secondary-color: #333652;\n$highlight-color: #fad02c;\n$active-color: #90adc6;\n$submit-color: #84d4b7;\n$cancel-color: rgb(235, 132, 132);\n$border-radius__outer: 6px;\n$border-radius__inner: 4px;\n$input-button-height: 42px;\n\nbody {\n  background-color: $primary-color;\n  font-size: 18px;\n}\n\n.main-grid {\n  position: relative;\n  min-height: 100vh;\n  .content-wrap {\n    padding-bottom: 2.5rem;\n  }\n}\n\n.flex {\n  display: flex;\n}\n\nheader {\n  background-color: $secondary-color;\n  color: $primary-color;\n  height: 64px;\n  padding: 0.7em;\n  padding-right: 1em;\n  div {\n    display: flex;\n    justify-content: space-between;\n  }\n  .hero {\n    font-size: 36px;\n  }\n}\n\nbutton,\n.submit-btn {\n  border: none;\n}\n\n.nav,\nheader {\n  button {\n    background-color: transparent;\n    color: $primary-color;\n    i {\n      font-size: 36px;\n    }\n  }\n}\n\n.nav {\n  &.open {\n    width: 100%;\n    padding-left: 20px;\n  }\n  height: 100vh;\n  width: 0;\n  position: fixed;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  background-color: $secondary-color;\n  color: $primary-color;\n  overflow-x: hidden;\n  transition: 0.5s;\n  padding-top: 3em;\n  font-size: 24px;\n  z-index: 100;\n  ul {\n    margin-bottom: 1em;\n    li {\n      margin-bottom: 0.3em;\n    }\n  }\n  a {\n    color: $primary-color;\n    &:visited {\n      color: $primary-color;\n    }\n    &:hover {\n      color: $highlight-color;\n    }\n    i {\n      margin-right: 10px;\n    }\n  }\n  .close-nav-btn {\n    line-height: 38.7px;\n    padding-bottom: 6.2px;\n    position: absolute;\n    top: 15px;\n    right: 25px;\n    font-size: 58px;\n    margin-left: 50px;\n  }\n  .line {\n    height: 1px;\n    background: $primary-color;\n    max-width: 90%;\n    margin-bottom: 0.5em;\n  }\n}\n\n.dash-board {\n  padding: 1em;\n}\n\n.form {\n  margin: 0 auto;\n  padding: 25px;\n  padding-bottom: 50px;\n  max-width: 400px;\n  border: 1px solid black;\n  border-radius: $border-radius__outer;\n  &.open {\n    display: none;\n  }\n  input,\n  fieldset {\n    margin-bottom: 12px;\n  }\n  input,\n  .cancel-btn {\n    height: $input-button-height;\n  }\n  .task-input,\n  textarea {\n    width: 100%;\n  }\n  fieldset {\n    border: none;\n    padding-bottom: 15px;\n  }\n  textarea {\n    resize: none;\n  }\n  textarea,\n  input,\n  .radio-btn > label {\n    padding-left: 5px;\n    padding-right: 5px;\n    border-radius: $border-radius__inner;\n  }\n  input,\n  textarea {\n    border: 1px solid black;\n  }\n  #task-date {\n    &:hover {\n      cursor: pointer;\n    }\n  }\n  .radio-container {\n    display: grid;\n    grid-template-columns: repeat(3, 1fr);\n    gap: 10px;\n  }\n  .radio-btn {\n    position: relative;\n    label,\n    input {\n      display: block;\n    }\n    input[type='radio'] {\n      opacity: 0.011;\n      z-index: 100;\n      position: absolute;\n      &:checked + label {\n        border: 2px solid transparent;\n      }\n    }\n    .low + label {\n      background-color: red;\n    }\n    .medium + label {\n      background-color: green;\n    }\n    .high + label {\n      background-color: blue;\n    }\n    label {\n      border: 2px solid black;\n      padding: 2px 6px;\n      text-align: center;\n      cursor: pointer;\n      z-index: 90;\n      line-height: 1.8em;\n    }\n  }\n  .form-btn-container {\n    float: right;\n    .submit-btn {\n      background-color: $submit-color;\n      border: none;\n      margin-left: 4px;\n      &:hover {\n        cursor: pointer;\n      }\n    }\n    .cancel-btn {\n      background-color: $cancel-color;\n    }\n    .submit-btn,\n    .cancel-btn {\n      padding: 0.5em 0.6em;\n      border-radius: $border-radius__inner;\n    }\n  }\n}\n\nfooter {\n  text-align: center;\n  position: absolute;\n  bottom: 0;\n  width: 100%;\n  height: 2.5rem;\n}\n"],"sourceRoot":""}]);
// Exports
