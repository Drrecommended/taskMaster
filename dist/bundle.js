...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n}\n\nmain {\n  flex-grow: 1;\n}\n\nbutton {\n  background-color: white;\n  min-height: 54px;\n  min-width: 54px;\n}\n\nbutton, .cancel__btn,\ninput {\n  padding: 10px 15px;\n  border: 2px solid black;\n}\n\n.cancel__btn {\n  background-color: rgb(224, 105, 105);\n  color: white;\n}\n\n.submit__btn {\n  background-color: green;\n  color: white;\n}\n\n.wrapper {\n  max-width: 1200px;\n  padding: 14px;\n  margin: 0 auto;\n  display: flex;\n  justify-content: space-between;\n}\n\nheader {\n  background-color: white;\n}\n\n.nav {\n  background-color: wheat;\n  height: 100%;\n  width: 0;\n  position: fixed;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  overflow-x: hidden;\n  transition: 0.4s;\n  padding-top: 80px;\n}\n.nav.open {\n  width: 320px;\n  max-width: 100%;\n}\n.nav h2 {\n  font-size: 28px;\n}\n.nav .task-pages,\n.nav .project-controls_header {\n  margin-bottom: 14px;\n}\n.nav a {\n  padding: 8px 8px 8px 32px;\n  text-decoration: none;\n  font-size: 25px;\n  display: block;\n  transition: 0.3s;\n}\n.nav .close-nav_btn {\n  position: absolute;\n  top: 14px;\n  right: 14px;\n  margin-left: 50px;\n}\n.nav .divider-line,\n.nav .project-controls_header,\n.nav .cancel {\n  margin-right: 14px;\n}\n.nav .divider-line {\n  border-bottom: 2px solid black;\n  display: block;\n  margin-left: 32px;\n  margin-bottom: 10px;\n  max-width: 90%;\n}\n.nav .project-controls_header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav .project-controls,\n.nav .project-controls_header {\n  padding-left: 32px;\n}\n.nav .project-controls {\n  width: 90%;\n  display: none;\n}\n.nav .project-controls .show-controls {\n  display: block;\n}\n.nav .project-controls input {\n  display: block;\n  width: 100%;\n  margin-bottom: 5px;\n}\n.nav .project-controls .cancel {\n  margin-left: 5px;\n}\n\n.form {\n  width: 100%;\n  background-color: lightblue;\n}\n.form input, .form textarea {\n  width: 100%;\n  border: 2px solid black;\n}\n.form .radio__container {\n  display: flex;\n  justify-content: space-around;\n  text-align: center;\n}\n.form .form-btn__container {\n  display: flex;\n  gap: 5px;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAKA;EACE,iBAAA;EACA,aAAA;EACA,sBAAA;AAHF;;AAMA;EACE,YAAA;AAHF;;AAQA;EACE,uBAAA;EACA,gBAAA;EACA,eAAA;AALF;;AAQA;;EAEE,kBAAA;EACA,uBAAA;AALF;;AAQA;EACE,oCA5Ba;EA6Bb,YAAA;AALF;;AAQA;EACE,uBAhCa;EAiCb,YAAA;AALF;;AASA;EACE,iBAAA;EACA,aAAA;EACA,cAAA;EACA,aAAA;EACA,8BAAA;AANF;;AASA;EACE,uBAAA;AANF;;AAaA;EACE,uBAAA;EACA,YAAA;EACA,QAAA;EACA,eAAA;EACA,UAAA;EACA,MAAA;EACA,OAAA;EACA,kBAAA;EACA,gBAAA;EACA,iBAAA;AAVF;AAWE;EACE,YAAA;EACA,eAAA;AATJ;AAWE;EACE,eAAA;AATJ;AAWE;;EAEE,mBAAA;AATJ;AAWE;EACE,yBAAA;EACA,qBAAA;EACA,eAAA;EACA,cAAA;EACA,gBAAA;AATJ;AAWE;EACE,kBAAA;EACA,SAAA;EACA,WAAA;EACA,iBAAA;AATJ;AAWE;;;EAGE,kBAAA;AATJ;AAWE;EACE,8BAAA;EACA,cAAA;EACA,iBAAA;EACA,mBAAA;EACA,cAAA;AATJ;AAWE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;AATJ;AAWE;;EAEE,kBAAA;AATJ;AAWE;EACE,UAAA;EACA,aAAA;AATJ;AAUI;EACE,cAAA;AARN;AAUI;EACE,cAAA;EACA,WAAA;EACA,kBAAA;AARN;AAUI;EACE,gBAAA;AARN;;AAaA;EAEE,WAAA;EACA,2BAAA;AAXF;AAYE;EACE,WAAA;EACA,uBAAA;AAVJ;AAYE;EACE,aAAA;EACA,6BAAA;EACA,kBAAA;AAVJ;AAYE;EACE,aAAA;EACA,QAAA;AAVJ","sourcesContent":["@import url('reset.css');\n\n$cancel-color: rgb(224, 105, 105);\n$submit-color: green;\n\nbody {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n}\n\nmain {\n  flex-grow: 1;\n}\n\n\n\nbutton {\n  background-color: white;\n  min-height: 54px;\n  min-width: 54px;\n}\n\nbutton, .cancel__btn,\ninput {\n  padding: 10px 15px;\n  border: 2px solid black;\n}\n\n.cancel__btn {\n  background-color: $cancel-color;\n  color: white;\n}\n\n.submit__btn {\n  background-color: $submit-color;\n  color: white;\n}\n\n\n.wrapper {\n  max-width: 1200px;\n  padding: 14px;\n  margin: 0 auto;\n  display: flex;\n  justify-content: space-between;\n}\n\nheader {\n  background-color: white;\n  // .wrapper {\n  //   display: flex;\n  //   justify-content: space-between;\n  // }\n}\n\n.nav {\n  background-color: wheat;\n  height: 100%;\n  width: 0;\n  position: fixed;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  overflow-x: hidden;\n  transition: 0.4s;\n  padding-top: 80px;\n  &.open {\n    width: 320px;\n    max-width: 100%;\n  }\n  h2 {\n    font-size: 28px;\n  }\n  .task-pages,\n  .project-controls_header {\n    margin-bottom: 14px;\n  }\n  a {\n    padding: 8px 8px 8px 32px;\n    text-decoration: none;\n    font-size: 25px;\n    display: block;\n    transition: 0.3s;\n  }\n  .close-nav_btn {\n    position: absolute;\n    top: 14px;\n    right: 14px;\n    margin-left: 50px;\n  }\n  .divider-line,\n  .project-controls_header,\n  .cancel {\n    margin-right: 14px;\n  }\n  .divider-line {\n    border-bottom: 2px solid black;\n    display: block;\n    margin-left: 32px;\n    margin-bottom: 10px;\n    max-width: 90%;\n  }\n  .project-controls_header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n  }\n  .project-controls,\n  .project-controls_header {\n    padding-left: 32px;\n  }\n  .project-controls {\n    width: 90%;\n    display: none;\n    .show-controls {\n      display: block;\n    }\n    input {\n      display: block;\n      width: 100%;\n      margin-bottom: 5px;\n    }\n    .cancel {\n      margin-left: 5px;\n    }\n  }\n}\n\n.form {\n  // display: none;\n  width: 100%;\n  background-color: lightblue;\n  input, textarea {\n    width: 100%;\n    border: 2px solid black;\n  }\n  .radio__container {\n    display: flex;\n    justify-content: space-around;\n    text-align: center;\n  }\n  .form-btn__container {\n    display: flex;\n    gap: 5px;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
