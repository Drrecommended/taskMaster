...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "button {\n  background-color: white;\n  min-height: 58px;\n  min-width: 58px;\n}\n\n.wrapper {\n  max-width: 1200px;\n  padding: 14px;\n  margin: 0 auto;\n}\n\nheader {\n  background-color: wheat;\n}\nheader .wrapper {\n  display: flex;\n  justify-content: space-between;\n}\n\n.nav {\n  background-color: wheat;\n  height: 100%;\n  width: 0;\n  position: fixed;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  overflow-x: hidden;\n  transition: 0.4s;\n  padding-top: 80px;\n}\n.nav h2 {\n  font-size: 28px;\n}\n.nav .task-pages {\n  margin-bottom: 14px;\n}\n.nav a {\n  padding: 8px 8px 8px 32px;\n  text-decoration: none;\n  font-size: 25px;\n  display: block;\n  transition: 0.3s;\n}\n.nav .close-nav_btn {\n  position: absolute;\n  top: 14px;\n  right: 14px;\n  font-size: 36px;\n  margin-left: 50px;\n}\n.nav.open {\n  width: 320px;\n}\n.nav .divider-line,\n.nav .project-controls {\n  margin-right: 14px;\n}\n.nav .divider-line {\n  border-bottom: 2px solid black;\n  display: block;\n  margin-left: 32px;\n  margin-bottom: 10px;\n  max-width: 90%;\n}\n.nav .project-controls {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 32px;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAEA;EACE,uBAAA;EACA,gBAAA;EACA,eAAA;AAAF;;AAGA;EACE,iBAAA;EACA,aAAA;EACA,cAAA;AAAF;;AAGA;EACE,uBAAA;AAAF;AAEE;EACE,aAAA;EACA,8BAAA;AAAJ;;AAIA;EACE,uBAAA;EACA,YAAA;EACA,QAAA;EACA,eAAA;EACA,UAAA;EACA,MAAA;EACA,OAAA;EACA,kBAAA;EACA,gBAAA;EACA,iBAAA;AADF;AAEE;EACE,eAAA;AAAJ;AAEE;EACE,mBAAA;AAAJ;AAEE;EACE,yBAAA;EACA,qBAAA;EACA,eAAA;EACA,cAAA;EACA,gBAAA;AAAJ;AAEE;EACE,kBAAA;EACA,SAAA;EACA,WAAA;EACA,eAAA;EACA,iBAAA;AAAJ;AAEE;EACE,YAAA;AAAJ;AAEE;;EAEE,kBAAA;AAAJ;AAEE;EACE,8BAAA;EACA,cAAA;EACA,iBAAA;EACA,mBAAA;EACA,cAAA;AAAJ;AAEE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,kBAAA;AAAJ","sourcesContent":["@import url('reset.css');\n\nbutton {\n  background-color: white;\n  min-height: 58px;\n  min-width: 58px;\n}\n\n.wrapper {\n  max-width: 1200px;\n  padding: 14px;\n  margin: 0 auto;\n}\n\nheader {\n  background-color: wheat;\n\n  .wrapper {\n    display: flex;\n    justify-content: space-between;\n  }\n}\n\n.nav {\n  background-color: wheat;\n  height: 100%;\n  width: 0;\n  position: fixed;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  overflow-x: hidden;\n  transition: 0.4s;\n  padding-top: 80px;\n  h2 {\n    font-size: 28px;\n  }\n  .task-pages {\n    margin-bottom: 14px;\n  }\n  a {\n    padding: 8px 8px 8px 32px;\n    text-decoration: none;\n    font-size: 25px;\n    display: block;\n    transition: 0.3s;\n  }\n  .close-nav_btn {\n    position: absolute;\n    top: 14px;\n    right: 14px;\n    font-size: 36px;\n    margin-left: 50px;\n  }\n  &.open {\n    width: 320px;\n  }\n  .divider-line,\n  .project-controls {\n    margin-right: 14px;\n  }\n  .divider-line {\n    border-bottom: 2px solid black;\n    display: block;\n    margin-left: 32px;\n    margin-bottom: 10px;\n    max-width: 90%;\n  }\n  .project-controls {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding-left: 32px;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
